...
import com.example.myapplication.HideActivity
import com.example.myapplication.R
import com.example.myapplication.databinding.ActivityStarterBinding
import com.example.myapplication.feature.pairing.utils.AdbClient
import com.example.myapplication.feature.pairing.utils.AdbKey
import com.example.myapplication.feature.pairing.utils.AdbKeyException
import com.example.myapplication.feature.pairing.utils.PreferenceAdbKeyStore
...
import com.example.myapplication.utilsjava.AppConstants.EXTRA
...
class StarterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivityStarterBinding.inflate(layoutInflater)
            ...
            if (output.endsWith("info: shizuku_starter exit with 0")) {
                ...
                when (it.error) {
                    ...
                    is NotRootedException -> {
                        message =  R.string.adb_error_key_store
//                        R.string.start_with_root_failed
                    }
                    is ConnectException -> {
...
private class ViewModel(context: Context, root: Boolean, host: String?, port: Int) : androidx.lifecycle.ViewModel() {
    ...
    val _output = MutableLiveData<Resource<StringBuilder>>()
    ...
    private fun startRoot() {
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            Starter.writeDataFiles(HideActivity().applicationContext)
    ...
    private fun startAdb(host: String, port: Int) {
        ...
        GlobalScope.launch(Dispatchers.IO) {
             ...
             */
            if (sb.contains("/Android/data/com.example.myapplication/start.sh: Permission denied")) {
                sb.append('\n')
                ...
                Starter.writeDataFiles(HideActivity().applicationContext, true)
