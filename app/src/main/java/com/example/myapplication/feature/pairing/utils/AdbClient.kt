package com.example.myapplication.feature.pairing.utils

import android.util.Log
import com.example.myapplication.feature.pairing.utils.AdbProtocol.ADB_AUTH_RSAPUBLICKEY
import com.example.myapplication.feature.pairing.utils.AdbProtocol.ADB_AUTH_SIGNATURE
import com.example.myapplication.feature.pairing.utils.AdbProtocol.ADB_AUTH_TOKEN
import com.example.myapplication.feature.pairing.utils.AdbProtocol.A_AUTH
import com.example.myapplication.feature.pairing.utils.AdbProtocol.A_CLSE
import com.example.myapplication.feature.pairing.utils.AdbProtocol.A_CNXN
import com.example.myapplication.feature.pairing.utils.AdbProtocol.A_MAXDATA
import com.example.myapplication.feature.pairing.utils.AdbProtocol.A_OKAY
import com.example.myapplication.feature.pairing.utils.AdbProtocol.A_OPEN
import com.example.myapplication.feature.pairing.utils.AdbProtocol.A_STLS
import com.example.myapplication.feature.pairing.utils.AdbProtocol.A_STLS_VERSION
import com.example.myapplication.feature.pairing.utils.AdbProtocol.A_VERSION
import com.example.myapplication.feature.pairing.utils.AdbProtocol.A_WRTE
...
class AdbClient(private val host: String, private val port: Int, private val key: AdbKey) :
    ...
    fun connect() {
        ...
        if (message.command == A_STLS) {
            ...
            Log.d("ADB Client", "Handshake succeeded.")
    ...
    private fun write(message: AdbMessage) {
        ...
        outputStream.flush()
        Log.d("ADB Client", "write ${message.toStringShort()}")
    }
    ...
    private fun read(): AdbMessage {
        ...
        Log.d("ADB Client", "read ${message.toStringShort()}")
        return message
    }
